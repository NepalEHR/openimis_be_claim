# Generated by Django 2.1.14 on 2021-03-29 21:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scheme_type', models.IntegerField(blank=True, db_column='SchemeType', null=True)),
                ('subProduct_id', models.IntegerField(blank=True, db_column='subProduct_id', null=True)),
            ],
            options={
                'db_table': 'tblClaim',
                'managed': False,
